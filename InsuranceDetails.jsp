          ...
          <ul class="sidebar-menu">
            <li class="header">MAIN NAVIGATION</li>
              <li class="active treeview">
              	<a href="InsuranceHomePage.jsp"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
              <li class="active treeview">
              	<a href="InsuranceDetails.jsp"><i class="glyphicon glyphicon-folder-open"></i> <span>Insurance Details</span></a></li>
              <li class="active treeview">
              	<a href="UserHistoryInsurance.jsp"><i class="fa fa-envelope"></i> <span>User History Insurance</span></a></li>
              <li class="active treeview">
              ...
              <section class="col-lg-12 connectedSortable">
               <div class="box box-success">
                <div class="box-header">
                  ...
                  <h3 class="box-title"><b>Insurance Details:-</b></h3>
                ...
                <div class="card-body">
                  <form action="InsuranceDetails" method="post">
                    <div class="row">
                      <div class="col-md-5">
                    ...
                    <label class="bmd-label-floating" style="color: purple;">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Company_Name</label> <input
														type="text" class="form-control" name="txtcompany"
														value="<%=name %>" readonly="readonly">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Contact Detail</label> <input
														type="text" class="form-control" name="txtmobile"
														value="<%=contact %>" readonly="readonly">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">WeSite</label> <input
														type="text" class="form-control" name="txtwebsite"
														value="<%=website %>" readonly="readonly">
												</div>
											</div>
											<!-- <div class="col-md-12">
												<div class="form-group">
                    ...
                    <label class="bmd-label-floating" style="color: purple;"> Insurance Form Details:-</label>
                      <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                      ...
                      <div class="col-md-4">
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Policy_Tenue(Yr)</label>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Base_Premium </label>
                 ...
                 <center><input type="submit" name="submit" class="btn btn-primary pull-right" value="Save"></center>
