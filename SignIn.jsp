          ...
          <div class="row">
            ...
            <br></br>
              ...
              <div class="box box-solid bg-light-blue-gradient">
               ...
               <form class="post_section" action="doLogin" method="post">
                    ...
                    <tbody>
                      ...
                      <tr>
							...
							<td><select style="width: 180px; height: 30px"
								id="username" name="infodata" style="color: #0000;" required="required">
                  ...
                  <h3><p class="mt-20" align="center">New in this site ?<a href="SignUp1.jsp"><font color="black"><b> Create New Account</b></font></a>&nbsp;|&nbsp;
                  <a class="active" href="ForgetPassword.jsp"><font color="black"><b></b></font></a></</p></h3>
                  </div>
              </div>
            </section>
