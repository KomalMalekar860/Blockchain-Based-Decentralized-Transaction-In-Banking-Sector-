              ...
              <section class="col-lg-12 connectedSortable">
               <div class="box box-success">
                <div class="box-header">
                  ...
                  <h3 class="box-title"><b>Sign Up to the System</b></h3>
          	...
          	<form action="Registration" method="post">
                  <table class="table table-hover" border="5">
                    <tbody align="center">
                      ...
                      <tr>
                        <td>Select Roll:</td>
						<td><select style="width: 235px; height: 30px" name="roll" style="width:75%">
                      ...
                      <tr>
                        <td>Contact No:</td>
                        <td><input type="text" name="txtcontact" pattern="[7-9]{1}[0-9]{9}" maxlength="10" placeholder="8888888888" maxlength="10" required></td>
                        <td></td>
                      </tr>
                      <tr>
                        <td>Address:</td>
                      ...
                      <tr>
                      	<td>WebSite:</td>
						<td><input type="text" id="txtwebsite" name="txtwebsite" placeholder="Please Enter Website URL" required="required"></td>
                        <td></td>
                      </tr>
                      <tr>
                        <td>Password:</td>
                      ...
                      <tr>
                        ...
                        <td><input type="password" name="cpassword" placeholder="Please Enter Conform Password" required></td>
                        <td></td>
                      </tr>
                      <tr>
