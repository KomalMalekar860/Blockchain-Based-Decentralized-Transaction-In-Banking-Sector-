...
option:first-child
{
  ...
  %>
	...
	<form id="form1" name="form1" method="post" action="">
	  <table style="background-color: #008000;">
        ...
        <tr>
          ...
          <td><div align="right"><strong>:</strong></div></td>
          <td>&nbsp;<font color="#FFFFF"><%=bal%> Rs. </font></td>
        </tr>
        <tr>
          <td colspan="3" align="center"><br>&nbsp;If you want to Deposit then <a href="deposite.jsp">Click Here</a><br/> Or For Withdrawal  the Amount for Your Account <a href="withdraw.jsp">Click here</a></td>
          </tr>
        <tr>
          <td width="43%">&nbsp;</td>
          <td width="2%">&nbsp;</td>
