...
th:nth-child(even),td:nth-child(even) {
  ...
  <%
              ...
              <section class="col-lg-12 connectedSortable">
               <div class="box box-success">
                <div class="box-header">
                  ...
                  <h3 class="box-title"><b>Transfer Amount From Account:-</b></h3>
	...
	<form id="form1" name="form1" method="post" action="dbTransfer">
	  <table align="center">     
        <tr>
          <td colspan="3" align="center"><h3>Transfer Amount</h3></</td>
        </tr>
        <tr>
        ...
        <tr>
          <td ><strong>Select Source Account No.</strong></td>
          <td>:</td>
        ...
        <tr>
          <td><strong>Select Destination Account No. </strong></td>
          <td>:</td>
          <td><label>
            <select name="daccNo">
              <%
        ...
        <tr>
          ...
          <td>:</td>
          <td><label>
            <textarea name="textfield2" cols="30" rows="2" required></textarea>
          </label></td>
        </tr>
        <tr>
